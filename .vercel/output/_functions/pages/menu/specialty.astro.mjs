...
const $$Specialty = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MenuLayout", $$MenuLayout, { "category": Category.specialty })}`;
}, "/Users/tsekushi/dev/ubean/src/pages/menu/specialty.astro", void 0);

const $$file = "/Users/tsekushi/dev/ubean/src/pages/menu/specialty.astro";
const $$url = "/menu/specialty";
